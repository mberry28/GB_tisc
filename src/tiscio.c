...
int match_parameter (char *str1, char *str2, int show, int replace, char *line)
{
	...
	Match_Param_Replace_int ( "switch_topo_out", switch_topo_out, 0 ) //added by M Berry
 	Match_Param_Replace_flt ( "tau_c",           tau_c,              0)//added by michael berry
 	Match_Param_Replace_int ( "switch_rand_time", switch_rand_time, 0 ) //added by M Berry
 	Match_Param_Replace_int ( "switch_profile",  	switch_profile,  	0 ) //added by M Berry
 	Match_Param_Replace_int ( "switch_3dtopo",  	switch_3dtopo,  	0 ) //added by M Berry
 	Match_Param_Replace_int ( "switch_basin_out",  	switch_basin_out,		0	) //added by M Berry
 	Match_Param_Replace_int ( "diff_loss",  	diff_loss,		0	) //added by M Berry
...
int read_file_resume(char *filename)
{
  ...
  fread(&switch_drainage_loss, sizeof(BOOL), 1, file); // M BERRY // 03162020
...
int write_file_resume()
{
	...
	*/
	...
	fwrite(&switch_drainage_loss, sizeof(BOOL), 1, file); // M BERRY
